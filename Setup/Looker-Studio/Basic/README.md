...
* Make a copy of the [**Looker Studio GA4 Basic Documentation report**](https://lookerstudio.google.com/u/0/reporting/c9dee2df-c333-44c0-9889-1b10eec1d9d2/page/p_nkztye53cd) 
...
#### platform_android_bool \[Calc\]

* **Field Name:** platform_android_bool \[Calc\]
* **Field ID:** platform_android_bool_calc

**Formula:**
```javascript
CASE
  WHEN Parameter Android App = "TRUE" THEN true
  ELSE false
END
```

#### platform_ios_bool \[Calc\]

* **Field Name:** platform_ios_bool \[Calc\]
* **Field ID:** platform_ios_bool_calc

**Formula:**
```javascript
CASE
  WHEN Parameter iOS App = "TRUE" THEN true
  ELSE false
END
```

#### platform_web_bool \[Calc\]

* **Field Name:** platform_web_bool \[Calc\]
* **Field ID:** platform_web_bool_calc

**Formula:**
```javascript
CASE
  WHEN Parameter Website = "TRUE" THEN true
  ELSE false
END
```
...
**Formula:**
```javascript
case when platform_android_bool [Calc] then '✔' else '' end
```
...
**Formula:**
```javascript
case when platform_ios_bool [Calc] then '✔' else '' end
```
...
**Formula:**
```javascript
case when platform_web_bool [Calc] then '✔' else '' end
```
