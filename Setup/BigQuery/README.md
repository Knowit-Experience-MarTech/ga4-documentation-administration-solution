...
3. Create 2 [**Cloud Run Functions**](#google-cloud-run-functions)
...
* You have to create 2 Cloud Run Functions, 1 for each scheduled query.

### Google Cloud Run Functions for the documentation solution
Create these 2 **Cloud Run Functions**:
...
| annotation_category | STRING | Annotation Category; GA4 Change History, GTM (Web), GTM (Server), GTM (iOS), GTM (Android), GTM (AMP), GA4 Annotation (Manual), GA4 Annotation (System) |
